...
function UserProfileCard({
    ...
    const statusLeaveTimer = useRef(null);
    ...
    const handleMouseEnter = () => {
        if (statusLeaveTimer.current) {
            clearTimeout(statusLeaveTimer.current);
            statusLeaveTimer.current = null;
        }
        setShowStatusFlyout(true);
    };

    const handleMouseLeave = () => {
        statusLeaveTimer.current = setTimeout(() => {
    ...
    useEffect(() => {
        return () => {
            if (statusLeaveTimer.current) clearTimeout(statusLeaveTimer.current);
        };
    }, []);
    ...
    const getStatusIcon = (statusValue, size = 16) => {
        switch (statusValue) {
            ...
            case 'idle': return <div className="status-dot idle" style={{ width: size, height: size }} />;
            case 'dnd': return <div className="status-dot dnd" style={{ width: size, height: size }} />;
            case 'focus': return <div className="status-dot focus" style={{ width: size, height: size }} />;
            case 'offline': return <div className="status-dot offline" style={{ width: size, height: size }} />;
                ...
                <div className="profile-card">
                    ...
                    <div className="profile-card-body">
                        ...
                        <div className="profile-card-menu">
                            ...
                            <button className="profile-card-menu-item profile-card-logout" onClick={handleLogout}>
                                <ArrowRightOnRectangleIcon className="icon-20" />
