          ...
          <div className="friend-avatar-wrapper">
            {friend.avatar_url ? (
              ...
              <div className="friend-avatar-placeholder">
                <DefaultAvatar 
                  backgroundColor={getAvatarColor(friend.user_id)}
                />
              </div>
            )}
            ...
            <div className="friends-list">
              ...
              {friends.length === 0 ? (
                <div className="friends-empty-state">
                  ...
                  <p className="empty-state-text">No one is online</p>
                </div>
              ) : (
                friends.map((friend) =>
                  renderFriendCard(
            ...
            <div className="friends-list">
              {pendingRequests.length === 0 && outgoingRequests.length === 0 ? (
                <div className="friends-empty-state">
                  ...
                  <p className="empty-state-text">There are no pending friend requests.</p>
                </div>
              ) : (
                <>
                  {pendingRequests.length > 0 && (
            ...
            <div className="friends-list">
              ...
              {blockedUsers.length === 0 ? (
                <div className="friends-empty-state">
                  ...
                  <p className="empty-state-text">you have no users blocked.</p>
                </div>
              ) : (
