...
import { CircleNotch, Users } from 'phosphor-react';
    ...
    return (
      <div className="join-invite-container">
        <div className="join-invite-content">
          <CircleNotch size={48} className="spinner" weight="bold" />
    ...
    <div className="join-invite-container">
      <div className="join-invite-card">
        <div className="invite-server-icon">
          {inviteInfo.guild_icon_url ? (
            <img src={inviteInfo.guild_icon_url} alt={inviteInfo.guild_name} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} />
          ) : (
        ...
        {inviteInfo.is_member ? (
          ...
          >
            {joining ? (
              <>
                <CircleNotch size={18} className="spinner" weight="bold" />
                Joining...
              </>
            ) : (
              'Accept Invite'
